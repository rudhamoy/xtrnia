      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 px-6 py-32 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className="mt-12 text-center">
            <Link
              href="/"
              className="group relative inline-block px-8 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/20 text-yellow-400 font-bold text-lg rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 hover:bg-white/15 min-w-[200px] text-center"
            >
